...
#define DialogBoxIndirectW(hInstance,lpTemplate,hWndParent,lpDialogFunc) DialogBoxIndirectParamW(hInstance,lpTemplate,hWndParent,lpDialogFunc,(LPARAM)0)
  ...
  typedef enum DIALOG_DPI_CHANGE_BEHAVIORS {
    DDC_DEFAULT = 0x00,
    DDC_DISABLE_ALL = 0x01,
    DDC_DISABLE_RESIZE = 0x02,
    DDC_DISABLE_CONTROL_RELAYOUT = 0x04
  ...
  typedef enum DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS {
    DCDC_DEFAULT = 0x00,
    DCDC_DISABLE_FONT_UPDATE = 0x01,
    DCDC_DISABLE_RELAYOUT = 0x02
...
#if WINVER >= 0x0605
  WINUSERAPI WINBOOL WINAPI AdjustWindowRectExForDpi(LPRECT lpRect, DWORD dwStyle, BOOL bMenu, DWORD dwExStyle, UINT dpi);
#endif
#endif
